...
```
cd existing_repo
git remote add origin https://gitlab.com/moeidtopcoder2/parloa.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/moeidtopcoder2/parloa/-/settings/integrations)
